...
export default function DropdownDecrease() {
  return (
	<svg style={{marginBottom: 5 + 'px', marginRight: 8 + 'px'}} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
